...
export default function Auction({ nfts, loading, error }: AuctionProps) {
    ...
    const renderSelectedSummary = () => {
        ...
        return (
                <section className="mx-auto w-full max-w-6xl overflow-hidden rounded-2xl border border-[rgb(50,255,52)]/80 bg-black/55 shadow-[0_16px_40px_rgba(5,20,5,0.35)] -mt-14">
